...
public class GeneratorCode {
    private static String author = "liucz";//作者名称
    private static String outputDir = "D:\\";//生成的位置
    private static String driver = "com.mysql.cj.jdbc.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url = "jdbc:mysql://localhost:3306/db_Test1?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
    private static String username = "root";//数据库用户名
    private static String password = "123456";//数据库密码
    private static String tablePrefix = "sys_";//数据库表的前缀，如t_user
    private static String[] tables = {"sys_user", "sys_role", "sys_permission", "sys_department" , "sys_emp"};   //生成的表
    private static String parentPackage = "com.trkj";//顶级包结构
