...
CREATE TABLE `proceeds` (
  `proceeds_id` bigint auto_increment NOT NULL COMMENT '编号',
  `meal_name` varchar(225) NOT NULL COMMENT '套餐名称',
  `p_name` varchar(225)  COMMENT '项目名称',
...
(395,'删除',96,'用户咨询','pay:counsult:delete',NULL,NULL,NULL,2,'el-icon-edit','2022-04-25 14:40:32','2022-04-25 14:40:32',NULL,NULL,0),
(396,'删除',89,'会员回访记录','pay:memberecord:delete',NULL,NULL,NULL,2,'el-icon-edit','2022-04-25 14:40:32','2022-04-25 14:40:32',NULL,NULL,0),
(397,'删除',90,'潜在用户回访记录','pay:prospectrecord:delete',NULL,NULL,NULL,2,'el-icon-edit','2022-04-25 14:40:32','2022-04-25 14:40:32',NULL,NULL,0);
insert  into sys_permission(`id`,`label`,`parent_id`,`parent_name`,`code`,`path`,`name`,`url`,`type`,`icon`,`create_time`,`update_time`,`remark`,`order_num`,`is_delete`) values
(398, '修改', 87, '潜在用户回访列表', 'prospects:prospects:editById', NULL, NULL, NULL, 2, 'el-icon-edit', '2022-04-25 14:40:32', '2022-04-25 14:40:32', NULL, NULL, 0);
